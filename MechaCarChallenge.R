...
mechaCarData <- read_csv("C:/Program Files/R/R-Analysis/MechaCar-Statistical-Analysis/MechaCar_mpg.csv")
...
suspension_coil_data <- read_csv("C:/Program Files/R/R-Analysis/MechaCar-Statistical-Analysis/Suspension_Coil.csv")
...
psi_lot1_sample <- suspension_coil_data %>% subset(Manufacturing_Lot=='Lot1') 

t.test(psi_lot1_sample$PSI,mu=mean(suspension_coil_data$PSI)) 

psi_lot2_sample <- suspension_coil_data %>% subset(Manufacturing_Lot=='Lot2') 

t.test(psi_lot2_sample$PSI,mu=mean(suspension_coil_data$PSI))

psi_lot3_sample <- suspension_coil_data %>% subset(Manufacturing_Lot=='Lot3') 
